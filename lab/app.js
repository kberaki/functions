...
function sum(a, b) { //eslint-disable-line
  ...
  let finalStatemets = 'The sum of ' + a + ' and ' + b + ' is ' + sumNumber + '.'
  return [sumNumber, finalStatemets]
  }
...
let multiplayNum = a * b
let finalAnswer = 'The product of ' + a + ' and ' + b + ' is ' + multiplayNum + '.'
return [multiplayNum, finalAnswer]
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let sumNumber1 = sum(a, b)
  let sumNum = sum (sumNumber1[0], c)
  let multiplayNum1 = multiply(a, b)
